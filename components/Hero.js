    ...
    <div className="pt-24 md:pt-8 px-6 mx-auto flex flex-wrap flex-col md:flex-row items-center">
      ...
      <div className="flex flex-col w-full xl:w-2/5 justify-center lg:items-start overflow-y-hidden">
        ...
        <div className="flex md:my-2">
          <button className="flex  text-white bg-purple-800 border py-2 px-6 focus:outline-none hover:bg-white hover:text-purple-800 hover:border-purple-800 rounded">
            <Link href="/projects">
              <a>My Projects</a>
            </Link>
          </button>
          <button className="flex ml-8 text-white bg-purple-800 border py-2 px-6 focus:outline-none hover:bg-white hover:text-purple-800 hover:border-purple-800 rounded">
            <img
